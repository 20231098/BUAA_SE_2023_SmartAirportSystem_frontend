            ...
            <div class="companylogin"  @keyup.enter="keyPressed">
                ...
                <el-form :model="loginForm" label-width="70px">
                    ...
                    <el-form-item label="航班ID" class="login_input_box" prop="FlightID">
                        <el-input v-model="Flightform.FlightId" placeholder="请输入航班名称"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="机票类型" class="login_input_box" prop="tickettype">
                        <el-input v-model="Flightform.tickettype" placeholder="请输入机票类型"></el-input>
                    </el-form-item>

                    <el-form-item label="机票价格" class="login_input_box" prop="price">
                        <el-input v-model="Flightform.price" placeholder="请输入机票价格"></el-input>
                    </el-form-item>

                    <el-form-item label="机票数量" class="login_input_box" prop="amount">
                        <el-input v-model="Flightform.amount" placeholder="请输入机票数量"></el-input>
                    </el-form-item>

                    <div class="button">
                        <el-button @click="submit_btn" class="submit_btn" type="primary">修改机票信息</el-button>
...
export default{
    ...
    methods:{
        ...
        submit_btn(){
          if(!this.Flightform.tickettype || !this.Flightform.FlightId|| !this.Flightform.price || !this.Flightform.amount || !this.Flightform.ticketid)
          {
            ...
            else if(!this.Flightform.tickettype){
              ElMessage({
                    type: 'error',
                    message: "机票类型不能为空！",
                    duration: 2000,
            ...
            else if(!this.Flightform.amount)
            {
                ElMessage({
                    type: 'error',
                    message: "机票数量不能为空！",
            ...
            else if(!this.Flightform.ticketid)
            {
                ElMessage({
                    type: 'error',
                    message: "机票ID不能为空!",
            ...
            this.$http({
                ...
                data: qs.stringify({
                  /* 需要向后端传输的数据，此处使用 qs.stringify 将 json 数据序列化以发送后端 */
                    ...
                    tickettype: this.Flightform.tickettype,

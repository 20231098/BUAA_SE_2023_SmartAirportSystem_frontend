          ...
          <el-main>
            <div class="companylogin"  @keyup.enter="keyPressed">
                ...
                <el-form :model="loginForm" label-width="70px">
                    ...
                    <div class="button">
                        <el-button @click="submit_btn" class="submit_btn" type="primary">添加机票信息</el-button>
...
export default{
    ...
    methods:{
        ...
        submit_btn(){
          if(!this.Flightform.tickettype || !this.Flightform.FlightId|| !this.Flightform.price || !this.Flightform.amount)
          {
